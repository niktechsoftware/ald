						    ...
						    <div style="background-color:lightblue;">
						            ...
						            <div class="row">
    						            ...
    						            <div class="col-md-5">
                                            ...
                                            <br>15 पेयर से 100 % बाइनरी 600 रू आलिमिटेड  डेफ्ट तक मिलता रहेगा |
                                     </label>
    						            </div>
    						        </div>
						    ...
						    <div class="row">
						        ...
						        <div class="col-md-5">
						            <label style="margin-top:1%;text-align:left;">
                                        ...
                                        <br>15 पेयर से 100 % बाइनरी 1800 रू आलिमिटेड  डेफ्ट तक मिलता रहेगा |
			                        </label>
						        </div>
						    </div>
						...
						<div style="background-color:lightblue;">
						    <div class="row">
						        ...
						        <div class="col-md-5">
                                    ...
                                    <br>15 पेयर से 100 % बाइनरी 6000 रू आलिमिटेड  डेफ्ट तक मिलता रहेगा |
    					       </label>
						        </div>
						    </div>
